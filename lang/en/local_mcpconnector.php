...
$string['chat_auth_broken'] = 'Authentication method "{$a}": Moodle reads that as a DISABLED account and refuses its token in EVERY web-service call, so the chat cannot talk to Moodle. Regenerate the identity to put it right.';
$string['chat_auth_ok'] = 'Authentication method "{$a}": enabled, so web services accept its token. It still cannot log in — the account has no usable password.';
...
$string['chat_error_auth_disabled'] = 'This site has the "manual" authentication method disabled, so the service account cannot be created with it — and any account Moodle considers disabled has its web-service token refused. Enable it in Site administration > Plugins > Authentication > Manage authentication, and try again.';
...
$string['chat_token_broken'] = 'Its token does NOT work: a real web-service call with it was refused ({$a}). Regenerate the identity.';
$string['chat_token_missing'] = 'It has NO Moodle web-service token.';
$string['chat_token_ok'] = 'It has a live Moodle web-service token.';
$string['chat_token_untested'] = 'Its token has not been tried yet: press "Check now" to make a real web-service call with it.';
$string['chat_token_works'] = 'Verified against Moodle itself: a real web-service call with that token works.';
